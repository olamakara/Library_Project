...
@Component
@Slf4j
public class AvailableBooksListController {
    ...
    public AvailableBooksListController(BookService bookService, BookViewController bookViewController) {
    ...
    private void initialize() {
        log.info("AvailableBookListController initialized");
    ...
    private VBox createBookVBox(Book book) {
        ...
        if (book.isAvailable()) {
            vbox.getStyleClass().add("available-book");
        } else {
            vbox.getStyleClass().add("unavailable-book");
        }
